...
<div class="Titulo">Criando Formulários</div>
...
<form action="#" method="post">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control <?=$erros['email'] ? 'is-invalid' : '' ?>" id="email" name="email" placeholder="Nome" value="<?= $_POST['email']?>">
